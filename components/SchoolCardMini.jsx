...
import CategoryGalleryEduChacha from "./CategoryGalleryEduChacha";
          ...
          <div className="flex  gap-5">
            ...
            <div className="w-[59%] flex flex-col space-y-4 ">
              <div className="flex justify-between mt-8">
                <div>
                  <p className="text-[20px] text-background-color">
              ...
              <div className="text-[#898989] flex pt-[1px] flex-col ">
                ...
                <p className="text-[16px] xl:text-[22px] text-background-color">
                  ₹{Number(data?.fields?.feefrom).toLocaleString("en-IN")} - ₹
                  {Number(data?.fields?.feeto).toLocaleString("en-IN")}
                </p>
              </div>

              <div className="w-full h-[60px] bg-background-color rounded-l-2xl flex justify-center items-center float-right">
              ...
              <div className="flex justify-between items-center gap-6 pt-2">
                ...
                <div className="w-[200px] space-y-4 text-[12px] mr-8">
                  <Link
                    ...
                    className="w-full px-5 py-2 rounded-3xl border border-[#02618f] text-background-color flex justify-center items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full px-5 py-2 rounded-3xl bg-background-color text-[#fff] flex justify-center items-center gap-2"
                  >
      ...
      <div className="lg:hidden">
        ...
        <div className="w-[85vw] md:w-[80vw]  md:h-[90vh] shadow-counsel px-[25px] py-[43px] space-y-2">
          <img
            ...
            src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1731995275/EduChacha/${citySlug}/G-${data?.fields?.Image_Code}.png`}
            alt="img"
          />

          <div className="space-y-2 h-auto">
            <div>
              <p className="text-[1rem]  font-semibold text-background-color">
                <Link href={`/school/${citySlug}/${data?.fields?.slug}`}>
                  {data?.fields?.name}
                </Link>
              </p>
            ...
            <div className="flex  space-x-12 p-3 font-semibold  text-[10px] bg-background-color rounded-l-2xl text-white  w-[109%] md:w-[315px]">
            ...
            <div className=" flex gap-2 text-[12px] pt-2">
              <Link
                href={`/school/${citySlug}/${data?.fields?.slug}`}
                className="w-full px-3 py-2 rounded-3xl border border-background-color text-background-color flex md:justify-center items-center  gap-2"
              >
              ...
              <button
                onClick={toggleBookingPopup}
                className="w-full px-3 py-2 rounded-3xl bg-background-color text-[#fff] flex justify-center items-center gap-2"
              >
