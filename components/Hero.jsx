        ...
        >
          <div className="px-8 md:px-20  lg:py-32 space-y-10 md:space-y-6 lg:space-y-10">
            {currentPath === "/" ? (
              ...
              <>
                <div className="headfont text-[28px] md:text-[60px] text-background-color font-bold w-full text-center pt-10 mt-20 mb-16 md:mt-0 md:mb-0 ">
                  <p>
                    Find
            ...
            >
              ...
              >
                <div
                  className={` border-background-color text-background-color flex w-[400px] h-full justify-between items-center border-r p-6 cursor-pointer`}
                ...
                <div
                  className={` border-background-color text-background-color flex w-[200px] h-full justify-between items-center border-l  p-6 cursor-pointer`}
              ...
              >
                <div
                  className={`border-[#02618f] text-[#02618f] flex w-full md:w-[80%] justify-between items-center border  rounded-md  p-4`}
                  onClick={handleSchoolType}
                >
              ...
              <div>
                <button
                  ...
                  className="bg-background-color px-6 py-4 text-white rounded-md border border-white"
                >
