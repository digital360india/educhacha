...
function FAQ({ categoryData }) {
  ...
  return (
    <div className="md:mt-10 mt-8">
      <div className=" w-full h-auto bg-background-color px-4 sm:px-8 md:px-[100px] pt-14 flex flex-col items-center">
        ...
        <div className="text-white text-[12px] sm:text-[14px] pt-8 text-justify sm:max-w-[90%]">
          <p>
            {isExpanded ? (
              <div
              style={{color:"white" }}
