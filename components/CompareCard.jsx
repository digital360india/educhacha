...
export default function CompareCard() {
  ...
  return (
    <>
      <h1 className="text-center text-background-color text-[24px] bg-gray-100 md:pt-20 pt-40">
        Compare By
      </h1>
      <div className="bg-gray-100 py-12 px-20">
        <div className="max-w-7xl mx-auto border border-background-color">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5">
            <div className="hidden lg:block px-3 p-4 space-y-4 border-r border-background-color  last:border-none flex-1 pt-10 ">
            <h3 className="text-center text-background-color font-semibold">
              Compare By:
            </h3>
            <div className="flex flex-col space-y-2 px-6">
              <button className="w-40 h-10 border border-background-color  text-background-color rounded">
                School Stats
              </button>
              <button className="w-40 h-10 border border-background-color text-background-color rounded">
                School Details
