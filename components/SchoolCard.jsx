...
const SchoolCard = ({ categoryData }) => {
  ...
  return (
    <>
      <div className="">
        <div className="bg-background-color w-full   md:h-[160px] md:flex md:justify-center md:items-center p-3  md:p-10">
          ...
          <div className="flex  justify-center sm:justify-start    items-center pb-10 md:pb-0 ">
            <div className="flex   justify-start w-[291px] h-[35px] sm:w-[100%] lg:h-[50px] lg:w-[100%] xl:w-[620px]  border-2 outline-none rounded-3xl   bg-background-color">
              <input
                onChange={handleSearch}
                className="xl:w-[890px] w-[240px] p-3 text-[#FFFFFF] rounded-3xl h-full bg-background-color placeholder:text-[#FFFFFF]  outline-none"
                type="text"
      ...
      <div className="  flex justify-center md:justify-start xl:justify-between sm:px-[70px] lg:gap-6">
        <div className="bg-white ">
          ...
          <div className="flex gap-3 text-black  items-center justify-center lg:w-[820px]   mt-4 ">
            ...
            <span className=" text-white cursor-pointer bg-background-color px-2 rounded-full">
              {page}
            </span>
            {
              <span
