    ...
    <>
      <div className="px-5 pt-3 text-[#000000]">
        <div className=" space-y-3 sm:space-y-2 ">
          ...
          <div className="pt-3">
            <div className="flex justify-center items-center border rounded-3xl h-[30px] w-[259px] border-background-color mx-auto cursor-pointer">
              <button
                onClick={() => handleClearFilter()}
                className="text-background-color text-[12px]"
              >
                Remove All Filters
              </button>
            </div>
