...
const CategoryGalleryEduChacha = ({ data, index, citySlug }) => {
        ...
        {['c1', 'c2', 'c3', 'c4'].map((cardId, idx) => (
          ...
          >
            <Image
              ...
              src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1731995275/EduChacha/${citySlug}/${
                ['G', 'I', 'H', 'G'][idx]
...
export default CategoryGalleryEduChacha;
