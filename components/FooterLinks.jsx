        ...
        <div className=" flex flex-col sm:flex-row gap-2 sm:gap-0 text-[12px] text-[#323232] pb-4   md:p-6 ">
          <div className="flex  flex-col  sm:items-center lg:w-[25vw]       ">
            <div className="flex flex-col">
              <Link
                href={
                  "https://www.educhacha.com/category/boarding-schools-in-dehradun"
                }
              >
              ...
              <Link
                href={
                  "https://www.educhacha.com/category/boarding-schools-in-mussoorie"
                }
              >
              ...
              <Link
                href={
                  "https://www.educhacha.com/category/boarding-schools-in-shimla"
                }
              >
          ...
          <div className="flex  flex-col  sm:items-center lg:w-[25vw]       ">
            <div className="flex flex-col">
              ...
              <Link
                href={
                  "https://www.educhacha.com/category/boarding-schools-in-india"
                }
              >
          ...
          <div className=" flex sm:justify-center sm:mt-0  lg:w-[27vw]">
            <div className="flex flex-col">
              <Link
                href={
                  "https://www.educhacha.com/category/boarding-schools-in-hyderabad"
                }
              >
