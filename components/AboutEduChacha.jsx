  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: `url(${Aboutuseduchacha.src})` }}
      >
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center items-center pt-16">
              ...
              >
                <button className="z-20 text-[#753A8A]">Read More</button>
              </div>
            </div>
            ...
            >
              <div className="relative ">
                ...
                <Image
                  ...
                  width={1000}
                  height={1000}
                  className={`absolute w-[400px] h-[400px] -bottom-[40px]  right-0 transition-transform duration-700 ease-in-out transform ${
