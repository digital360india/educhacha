...
const CompareSchoolCard = ({ onSchoolDataFetched }) => {
  ...
  return (
    <>
      {schooldetail == "" ? (
        <div className="rounded px-3 p-2 space-y-3 border-r border-background-color last:border-none">
          ...
          <h3 className="text-center text-background-color">Add school</h3>
          <div className="space-y-2">
            <div className="relative">
              <select
                value={location}
                onChange={(e) => setLocation(e.target.value)}
                className="w-full px-3 py-2 text-[#7A7A7A] bg-white border border-background-color rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-[#B8BBC2]"
              >
