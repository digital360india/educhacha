    ...
    <>
      ...
      >
        <div className="md:grid md:grid-cols-2 items-center h-full px-8 md:px-16">
          ...
          <div className="md:flex md:flex-col md:justify-center md:items-end md:text-right mt-[60%] sm:mt-[0%] space-y-4">
            <h1 className="text-[#023250] text-[24px] md:text-[40px] Merriweather">
              {school?.name}
            </h1>
      ...
      <section className=" sm:hidden    gap-8 overflow-scroll md:overflow-hidden mt-10 px-5">
        ...
        >
          <SwiperSlide className="">
            <img
              src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1731995275/EduChacha/${city}/G-${school?.Image_Code}.png`}
          ...
          <SwiperSlide className="">
            <img
              src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1731995275/EduChacha/${city}/H-${school?.Image_Code}.png`}
              className="w-[400px] h-[333px] rounded-3xl"
            />
            <div className="min-h-10"></div>
          </SwiperSlide>
          <SwiperSlide className="">
            <img
              src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1731995275/EduChacha/${city}/I-${school?.Image_Code}.png`}
              className="w-[400px] h-[333px] rounded-3xl"
            />
            <div className="min-h-10"></div>
          </SwiperSlide>
      ...
      <div className="w-full  mx-auto mt-10 ">
            ...
            <section className=" hidden  sm:block gap-8 rounded-t-[30px]  bg-[#F3F3F3]">
              <div className="bg-[#F3F3F3]">
                <div className="w-[40px] h-[40px] ml-6">
                  <p className="w-[40px] h-[40px] text-center pt-2 mt-8 rounded-full border border-background-color">
                    1
                  </p>
                </div>
                <hr className=" h-0.5 pt-[1px] bg-background-color ml-6 mr-6 mb-16 mt-4" />
                <img
                  src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1731995275/EduChacha/${city}/G-${school?.Image_Code}.png`}
                  alt="img"
              ...
              <div className="overflow-hidden">
                <section
                  className={`bg-background-color mb-32 text-white rounded-md p-4 h-[127px] flex justify-center items-center rounded-l-full top-20 right-0 transform transition-transform duration-[1800ms] ease-in-out ${slideClass}`}
                >
        ...
        <section className="md:sticky md:top-0 ">
          <div className="md:flex md:justify-between md:w-full  md:bg-background-color bg-[#F3F3F3] rounded-b-[100px] md:h-[487px] h-[503px] p-12 w-full">
            <div className=" ">
            ...
            <div className="hidden md:block">
              <button
                className="md:w-[200px] md:h-[40px] w-[125px] h-[36px] md:bg-background-button md:text-white text-[#323232] rounded-2xl    ml-auto"
                onClick={handle}
              >
                Write a review
              </button>
